...
- **Heading** — заголовок (уровни h1–h6).
- **Text** — основной текст.
...
- Core tokens (`src/styles/core.css`) — значения по умолчанию для обеих тем.
- Brand tokens (`src/styles/brands/{business,booking}.css`) — переопределение палитры, радиусов и шрифтов для каждого бренда.

Полный список токенов и их значения доступны в Storybook на странице **Foundations → Tokens**.
